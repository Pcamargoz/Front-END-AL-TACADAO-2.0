            ...
            <table className="w-full">
              <thead>
                <tr className="text-left text-xs text-[#4B5563] uppercase tracking-wider border-b border-[#1A1D24]">
                  <th className="px-4 sm:px-6 py-3 sm:py-4 min-w-[200px]">Produto</th>
                  <th className="px-4 sm:px-6 py-3 sm:py-4 hidden sm:table-cell min-w-[100px]">Marca</th>
                  ...
                  <th className="px-4 sm:px-6 py-3 sm:py-4 w-20 sm:w-24 min-w-[80px]">A��es</th>
                </tr>
              </thead>
