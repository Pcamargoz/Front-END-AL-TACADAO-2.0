...
export function ProductsPage() {
  ...
  return (
    <div className="min-h-screen bg-surface">
      ...
      <div className="container-apple py-6 sm:py-8 lg:py-12 safe-area-padding">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
          ...
          <main className="flex-1">
            ...
            {/* Products Grid/List */}
            {isLoading ? (
              <div className={`grid gap-5 ${view === "grid" ? "grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 lg:grid-cols-3" : "grid-cols-1"}`}>
                {[...Array(6)].map((_, i) => (
                  <div 
                    key={i} 
        ...
        {mobileFilterOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed right-0 top-0 bottom-0 w-80 max-w-[90vw] sm:max-w-[85vw] bg-surface border-l border-border z-50 lg:hidden overflow-y-auto"
            >
              {/* Header */}
